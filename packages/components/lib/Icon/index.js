...
export const Icon = ({ className, style, children = 'fa question', color = 'inherit', size = 'medium' }) => {
    ...
    if (children.startsWith('fa ')) {
        ...
        return (React.createElement(MUIIcon, { className: clsx(styles.root, className), style: style, color: color, fontSize: size }, children));
    }
};
